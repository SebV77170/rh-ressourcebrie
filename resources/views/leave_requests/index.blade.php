                                ...
                                @forelse ($leaveRequests as $leaveRequest)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            @else
                                                <span class="text-secondary small">Aucune action</span>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
    ...
    <div class="col-12 col-xl-4">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <p class="text-secondary">Cette nouvelle présentation met en avant les couleurs du logo avec des accents bleus et verts pour renforcer l’identité de la Ressource'Brie.</p>
